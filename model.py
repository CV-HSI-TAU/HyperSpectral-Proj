...
class OutConv(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv = nn.Conv2d(in_channels, out_channels, kernel_size=1, dilation=1)
...
class HyperNet(UNet):
    '''
    This Class treats the case of HyperNet
    '''

    def __init__(self, n_channels, n_output):
        super(HyperNet, self).__init__(n_channels = n_channels, n_classes = n_output)
        self.hyperspectral_dim = n_output
